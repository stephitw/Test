...
var c = canvas.getContext('2d'); //there we can draw in 2d
	...
	window.addEventListener('mousemove', //to add intereactivity with the canvas (monitor mouse mouvement=mousemove => add an anonymous function)
	...
	function Circle(x, y, dx, dy, radius, minRadius) { //Create a JS object (arguments = arguments new Object())
